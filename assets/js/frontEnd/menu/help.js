export function help() {
    ...
    <div class="backdrop-blur-sm bg-[#111827bd] border border-gray-500 rounded w-full max-h-[650px] xl:w-1/2 transition-all duration-500" id="helpMenu">
        <section class="flex flex-col items-center justify-center p-3 transition-opacity duration-500" id="helpMenuFirstChild">
