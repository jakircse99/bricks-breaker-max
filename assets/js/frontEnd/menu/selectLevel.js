export function selectLevel() {
    ...
    <div class="backdrop-blur-sm bg-[#111827bd] border border-gray-500 rounded w-full h-[450px] md:w-1/2 lg:w-1/2 transition-all duration-500" id="selectLevelParent">
      <section class="flex flex-col items-center justify-center transition-opacity duration-500" id="selectLevelFirstChild">
